...
def create_model(config: PretrainConfig, train_metadata: PuzzleDatasetMetadata, world_size: int):
    ...
    from models.hrm.trm import TinyRecursiveReasoningModel_ACTV1
    ...
    with torch.device("cuda"):
        ...
        model = loss_head_cls(model, train_metadata.dim, config.arch.hidden_size, **config.arch.loss.__pydantic_extra__)  # type: ignore
    ...
    has_puzzle_emb = (
        ...
        hasattr(model.model, 'puzzle_emb') and  # type: ignore
        model.model.config.puzzle_emb_ndim > 0  # type: ignore
    )
